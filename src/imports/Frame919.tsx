import svgPaths from "./svg-nhy92oxovn";
  ...
  return (
    <div className="h-[72px] relative shrink-0 w-full">
      <div aria-hidden="true" className="absolute inset-0 pointer-events-none">
        ...
        <img alt="" className="absolute max-w-none mix-blend-soft-light object-50%-50% object-cover opacity-20 size-full" src="/assets/8fb29c9b39c178de0ad31cdd7dd4862c29a944ba.png" />
      </div>
      ...
      <div aria-hidden="true" className="absolute border-[#52cbfa] border-[5px_0px_0px] border-solid inset-0 pointer-events-none" />
    </div>
  );
}
...
function Icon3() {
  return (
    <div className="relative shrink-0 size-[14px]" data-name="icon">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 14 14">
        <g id="icon">
          <path d={svgPaths.p2f760880} fill="var(--fill-0, #036345)" id="Vector" />
        </g>
      </svg>
    </div>
  );
...
function Icon4() {
  return <div className="shrink-0 size-[14px]" data-name="icon" />;
}
...
export default function Frame9() {
  return (
    <div className="bg-[#2f2f32] relative rounded-[6px] size-full">
